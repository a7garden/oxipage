//! Oxibuilder CLI — 모든 명령은 인증된 HTTP 호출 (doc/04 §4.1).
//!
//! 유일한 예외: `oxibuilder console`이 관리 콘솔을 띄운다.
...
#[command(
    name = "oxibuilder",
    version,
    about = "Oxibuilder personal-site CLI — every command is an authenticated HTTP call",
    long_about = "doc/04 §4.1: CLI는 API의 레퍼런스 클라이언트. 모든 쓰기/읽기는 인증된 HTTP 호출이다.\n유일한 예외는 serve 자체가 서버 프로세스를 기동하는 것뿐이다."
)]
pub struct Cli {
    #[arg(long, global = true, env = "OXIBUILDER_ENDPOINT")]
    pub endpoint: Option<String>,
    #[arg(long, global = true, env = "OXIBUILDER_SITE")]
    pub site: Option<String>,
    #[arg(long, global = true, env = "OXIBUILDER_TOKEN")]
    pub token: Option<String>,

    #[arg(long, global = true)]
    pub json: bool,

    #[arg(long, global = true, env = "OXIBUILDER_CONFIG")]
