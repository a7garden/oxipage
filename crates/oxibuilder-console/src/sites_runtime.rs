...
pub use oxibuilder_core::state::SiteScopedDb;
...
/// Context for one registered oxibuilder site.
pub struct SiteContext {
    ...
    pub settings: Arc<RwLock<oxibuilder_core::site_paths::MutableSiteSettings>>,
...
impl SiteRegistry {
    ...
    /// missing oxibuilder.toml, DB connect failure) are skipped with a warning.
    pub async fn new(
