...
function pathToStaticFile(path: string): string {
  ...
  // Collections/singletons map to /data/<segment>.json. Detail routes (blog/<slug>,
  // projects/<slug>) are NOT resolved here — fetchBlogPost/fetchProject pull them
  // client-side from the collection (the build emits full-body collection JSON).
  //   /blog           → /data/blog.json
